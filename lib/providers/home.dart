...
// Todo
// 1. Feed / Freetalk / Recipe => SubCollection 모두 삭제 후 Field Array로 변경
// 2. Search field로 where을 하는 search 함수 만들기
...
// 메인 식재료
  ...
  void get_data_search() async {
    ...
    if (top_index == 1) {
      ...
      await firestore
          .collection("Feed")
          .where('search', arrayContains: Searchtext)
          .orderBy("createdAt", descending: true)
          .limit(Fetch_count)
          .get()
          .then((QuerySnapshot querySnapshot) async {
