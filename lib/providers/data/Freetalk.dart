...
class Freetalk with ChangeNotifier {
  ...
  void update_data(String DocId, String Field, dynamic Value,
    ...
    if (Parameter != null) {
      // update
      await firestore.collection("Freetalk").doc(DocId).update(Parameter);
    }
    ...
    // 일반 field update
      ...
      // update
      await firestore.collection("Freetalk").doc(DocId).update({Field: Value});
    }
  ...
  void delete_data(String DocId, String State,
    ...
    if (State == "document") {
      // delete
      await firestore.collection("Freetalk").doc(DocId).delete();
    }
