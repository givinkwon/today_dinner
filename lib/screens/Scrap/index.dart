    ...
    if (context.watch<Home>().checkblacklist) {
      if (context.watch<Home>().check) {
        if (context.watch<Home>().checksearch) {
          ...
          if (context.watch<Home>().top_index == 2 &&
              context.watch<Home>().Freetalk.length - 1 >= widget.index) {
            ...
            return Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Text(
                              context.watch<Home>().top_index == 1
                                  ...
                                  : (context
                                      .watch<Home>()
                                      .Freetalk[widget.index]['nickname']),
                              style: TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
                              )),
                  ...
                  // Feed 댓글 2개 이상일 때
                  if (context.watch<Home>().top_index == 1 &&
                      context.watch<Home>().Feed[widget.index]['reply'] !=
                          null &&
              ...
              child: Row(
                children: <Widget>[
                  Text(
                    '식사',
                    style: TextStyle(
                        fontSize: 18, color: Color.fromRGBO(201, 92, 57, 1)),
                  ),
